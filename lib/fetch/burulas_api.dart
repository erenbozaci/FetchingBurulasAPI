...
class BurulasApi {
  static Future<List<SearchApi>> fetchSearch(String search) async {
    try {
      return fetchBurulasData<SearchApi>("api/static/routeandstation", {"keyword": search}, (data) => SearchApi.from(data));
    } catch (e) {
  ...
  static Future<List<RouteCoordinates>> fetchRouteCoordinates(String hatId) async {
    try {
      return fetchBurulasData<RouteCoordinates>("api/static/routecoordinate", {"keyword": hatId}, (data) => RouteCoordinates.fromJSON(data));
    } catch (e) {
  ...
  static Future<List<BusStop>> fetchBusStops(String hatId) async {
    try {
      return fetchBurulasData<BusStop>("api/static/routestat", {"routeCode": int.parse(hatId)}, (data) => BusStop.fromJSON(data));
    } catch (e) {
  ...
  static Future<List<DurakData>> getDurakData(String durakId) async {
    try {
      return fetchBurulasData<DurakData>("api/static/stationremainingtime", {"keyword": int.parse(durakId)}, (data) => DurakData.fromJSON(data));
    } catch (e) {
